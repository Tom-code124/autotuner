# Generated by Django 4.2.5 on 2023-10-29 19:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('database', '0003_alter_vehiclepotential_vehicle'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='customer',
            name='pricing_class',
            field=models.CharField(choices=[('M', 'Master'), ('S', 'Slave'), ('E', 'Euro')], default='E', max_length=1),
        ),
        migrations.AddField(
            model_name='processpricing',
            name='euro_price',
